...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task list__item-text text-item ";
    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button list__item-button_edit";

    deleteButton.className="button list__item-button_delete";
...
var editTask=function(){
    ...
    label.classList.toggle("list__item-label_edit");
    editInput.classList.toggle("list__item-text_edit");
};
...
var taskCompleted=function(){
    ...
    label.classList.toggle('list__item-label_complete');
